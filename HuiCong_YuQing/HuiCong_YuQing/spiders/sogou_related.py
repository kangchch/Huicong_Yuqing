...
class BaiduRelatedSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        exesql = settings['GET_HUICONG_YUQING_KEYWORD_SQL'].format('sogou_related'.upper(), settings['SELECT_STEP'])
    ...
    def parse(self, response):
        ...
        handles = response.xpath("//table[@id='hint_container']//a")
